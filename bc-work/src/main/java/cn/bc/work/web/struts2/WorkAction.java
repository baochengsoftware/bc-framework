...
import cn.bc.work.service.WorkService;
...
@Controller
public class WorkAction extends CrudAction<Long, Work> {
	private static final long serialVersionUID = 1L;
	private WorkService messageService;

	@Autowired
	public void setMessageService(WorkService messageService) {
